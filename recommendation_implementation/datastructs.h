...
void delete_data(vector <Twitter*>&,vector <Cluster*> & ,vector <Cluster*> &,vector <Cluster*> &, vector <DataVector *> &, vector <DataVector *> &,vector <DataVector *> &,vector <double> ** ,double ** ,vector <double> ** ,int L);
